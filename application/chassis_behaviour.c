...
#include "user_task.h"
extern user_control_t user_control;
/**
...
//        chassis_behaviour_mode = CHASSIS_NO_MOVE;
//    }
	if( switch_is_mid(user_control.user_RC->rc.s[USER_MODE_CHANNEL]) )//障碍块和救援
	{
		chassis_behaviour_mode = CHASSIS_NO_MOVE;
	}
	if( switch_is_up(user_control.user_RC->rc.s[USER_MODE_CHANNEL]) )//抓手、气缸
	{
		chassis_behaviour_mode = CHASSIS_NO_MOVE;
	}
...
//    else if (chassis_behaviour_mode == CHASSIS_INFANTRY_FOLLOW_GIMBAL_YAW)//跟随云台yaw轴
//    {
//        chassis_move_mode->chassis_mode = CHASSIS_VECTOR_FOLLOW_GIMBAL_YAW; 
//    }
    else if (chassis_behaviour_mode == CHASSIS_ENGINEER_FOLLOW_CHASSIS_YAW)//跟随底盘yaw轴
    {
        chassis_move_mode->chassis_mode = CHASSIS_VECTOR_FOLLOW_CHASSIS_YAW;
    }
    else if (chassis_behaviour_mode == CHASSIS_NO_FOLLOW_YAW)//底盘不跟随云台yaw轴，遥控器控制旋转，按键无旋转
    {
        chassis_move_mode->chassis_mode = CHASSIS_VECTOR_NO_FOLLOW_YAW;
    }
