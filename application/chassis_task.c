...
//
extern fp32 gimbal_yaw_angle;//在servo_task中
...
//    chassis_move_update->chassis_yaw = rad_format(*(chassis_move_update->chassis_INS_angle + INS_YAW_ADDRESS_OFFSET) - chassis_move_update->chassis_yaw_motor->relative_angle);
    chassis_move_update->chassis_yaw = rad_format(*(chassis_move_update->chassis_INS_angle + INS_YAW_ADDRESS_OFFSET) - gimbal_yaw_angle);
...
//	//上位机控制
//	extern FeedBackFrame_t tx_ctrl;	//回传上位机
//	extern ControlFrame_t  rx_ctrl;	//接收上位机数据
//	if( tx_ctrl.task_mode != NO_TASK )
//	{
//		// 摄像头到矿石的距离,不可能为负值，单位：MM
//		if( rx_ctrl.x_distance > 200.0f )	
//			vx_set_channel = chassis_move_rc_to_vector->vx_max_speed;
//		else if( rx_ctrl.x_distance < 180.0f )
//			vx_set_channel = -chassis_move_rc_to_vector->vx_max_speed;
//		// 左右平移距离
//		if( rx_ctrl.y_distance > 30.0f )
//			vy_set_channel = chassis_move_rc_to_vector->vy_max_speed;
//		else if( rx_ctrl.y_distance < -30.0f )
//			vy_set_channel = -chassis_move_rc_to_vector->vy_max_speed;
//	}
...
//		//改为云台舵机角度
//        sin_yaw = arm_sin_f32(-gimbal_yaw_angle);
//        cos_yaw = arm_cos_f32(-gimbal_yaw_angle);
        ...
        //计算旋转PID角速度
		chassis_move_control->wz_set = -PID_calc(&chassis_move_control->chassis_angle_pid, gimbal_yaw_angle, chassis_move_control->chassis_relative_angle_set);
...
//        chassis_move_control->chassis_yaw_set = rad_format(angle_set);		
		chassis_move_control->chassis_yaw_set = -(gimbal_yaw_angle) * ANGLE_TO_RAD;
